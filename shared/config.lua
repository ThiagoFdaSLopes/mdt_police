...
Config.RosterLink = {
    ['police'] = 'https://docs.google.com/spreadsheets/d/1Ef_Eeb14u4NF4f617GrNrGtp3DuhOQ9zffu6sbLNkVw/edit?usp=sharing',
    ['ambulance'] = '',
    ['bcso'] = '',
    ['doj'] = '',
}
...
-- this is a hack, because the nc-menu in nc-policejob populates an impound location and passed it through to the event.
