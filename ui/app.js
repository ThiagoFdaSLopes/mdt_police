  ...
  window.addEventListener("message", function (event) {
    ...
    if (eventData.type == "show") {
      ...
      activeUnits.forEach((unit) => {
        ...
        if (PoliceJobs[unit.unitType.toLowerCase()] !== undefined) {
          policeCount++;
          activeInfoJob = `<div class="unit-job active-info-job-lspd">LSPD</div>`;
        } else if (AmbulanceJobs[unit.unitType.toLowerCase()] !== undefined) {
        ...
        /* } else if  (DojJobs[unit.unitType] !== undefined) {
          ...
          fireCount++; */
        } else if (DojJobs[unit.unitType.toLowerCase()] !== undefined) {
